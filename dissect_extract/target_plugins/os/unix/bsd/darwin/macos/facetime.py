        ...
        try:
            ...
            for row in cursor:
                ...
                yield FaceTimeLinkRecord(
                    ts_created=self._cocoa_to_dt(row["ZCREATIONDATE"]) if "ZCREATIONDATE" in columns else None,
                    ts_expiry=self._cocoa_to_dt(row["ZEXPIRATIONDATE"]) if "ZEXPIRATIONDATE" in columns else None,
                    ts_deleted=self._cocoa_to_dt(row["ZDELETIONDATE"]) if "ZDELETIONDATE" in columns else None,
                    link_name=link_name,
                    pseudonym=pseudonym,
