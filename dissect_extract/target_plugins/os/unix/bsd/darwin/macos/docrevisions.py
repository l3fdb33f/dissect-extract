...
class MacOSDocRevisionsPlugin(Plugin):
    ...
    __namespace__ = "macos.docrevisions"
    ...
    def _parse_generations(self, db_path):
        ...
        try:
            ...
            if has_files:
                ...
                f_select = []
                f_select.append("f.path" if "path" in file_cols else "'' as path")
                ...
                g_select.extend(["'' as path", "'' as file_name", "0 as file_row_id"])
    ...
    def _parse_files(self, db_path):
        ...
        try:
            ...
            select = []
            select.append("path" if "path" in cols else "'' as path")
